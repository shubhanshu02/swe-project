 ...
 * Source Class: Report_Comment <br>
 * @version generated on Tue Mar 29 22:00:16 IST 2022 by shubh
 */

public interface Report_Comment extends Comment {

    /* ***************************************************
     * Property http://www.semanticweb.org/shubh/ontologies/2022/2/untitled-ontology-4#commented_on
     */
     
    /**
     * Gets all property values for the commented_on property.<p>
     * 
     * @returns a collection of values for the commented_on property.
     */
    Collection<? extends Progress_Report> getCommented_on();

    /**
     * Checks if the class has a commented_on property value.<p>
     * 
     * @return true if there is a commented_on property value.
     */
    boolean hasCommented_on();

    /**
     * Adds a commented_on property value.<p>
     * 
     * @param newCommented_on the commented_on property value to be added
     */
    void addCommented_on(Progress_Report newCommented_on);

    /**
     * Removes a commented_on property value.<p>
     * 
     * @param oldCommented_on the commented_on property value to be removed.
     */
    void removeCommented_on(Progress_Report oldCommented_on);

...
public interface Teacher extends Teaching_Staff {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/shubh/ontologies/2022/2/untitled-ontology-4#faculty_designation
     */
     
    /**
     * Gets all property values for the faculty_designation property.<p>
     * 
     * @returns a collection of values for the faculty_designation property.
     */
    Collection<? extends String> getFaculty_designation();

    /**
     * Checks if the class has a faculty_designation property value.<p>
     * 
     * @return true if there is a faculty_designation property value.
     */
    boolean hasFaculty_designation();

    /**
     * Adds a faculty_designation property value.<p>
     * 
     * @param newFaculty_designation the faculty_designation property value to be added
     */
    void addFaculty_designation(String newFaculty_designation);

    /**
     * Removes a faculty_designation property value.<p>
     * 
     * @param oldFaculty_designation the faculty_designation property value to be removed.
     */
    void removeFaculty_designation(String oldFaculty_designation);



    /* ***************************************************
     * Property http://www.semanticweb.org/shubh/ontologies/2022/2/untitled-ontology-4#faculty_id
     */
     
    /**
     * Gets all property values for the faculty_id property.<p>
     * 
     * @returns a collection of values for the faculty_id property.
     */
    Collection<? extends Integer> getFaculty_id();

    /**
     * Checks if the class has a faculty_id property value.<p>
     * 
     * @return true if there is a faculty_id property value.
     */
    boolean hasFaculty_id();

    /**
     * Adds a faculty_id property value.<p>
     * 
     * @param newFaculty_id the faculty_id property value to be added
     */
    void addFaculty_id(Integer newFaculty_id);

    /**
     * Removes a faculty_id property value.<p>
     * 
     * @param oldFaculty_id the faculty_id property value to be removed.
     */
    void removeFaculty_id(Integer oldFaculty_id);

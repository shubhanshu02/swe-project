 ...
 * Source Class: DefaultTeacher <br>
 * @version generated on Tue Mar 29 22:00:16 IST 2022 by shubh
 */
public class DefaultTeacher extends WrappedIndividualImpl implements Teacher {

    public DefaultTeacher(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends String> getFaculty_designation() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_FACULTY_DESIGNATION, String.class);
    }

    public boolean hasFaculty_designation() {
		return !getFaculty_designation().isEmpty();
    }

    public void addFaculty_designation(String newFaculty_designation) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_FACULTY_DESIGNATION, newFaculty_designation);
    }

    public void removeFaculty_designation(String oldFaculty_designation) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_FACULTY_DESIGNATION, oldFaculty_designation);
    }
    ...
    public Collection<? extends Integer> getFaculty_id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_FACULTY_ID, Integer.class);
    }

    public boolean hasFaculty_id() {
		return !getFaculty_id().isEmpty();
    }

    public void addFaculty_id(Integer newFaculty_id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_FACULTY_ID, newFaculty_id);
    }

    public void removeFaculty_id(Integer oldFaculty_id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_FACULTY_ID, oldFaculty_id);
    }

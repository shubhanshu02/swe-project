 ...
 * Source Class: DefaultTeaching_Assistant <br>
 * @version generated on Tue Mar 29 22:00:16 IST 2022 by shubh
 */
public class DefaultTeaching_Assistant extends WrappedIndividualImpl implements Teaching_Assistant {

    public DefaultTeaching_Assistant(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Student_Group> getAssigned_to() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ASSIGNED_TO,
                                               DefaultStudent_Group.class);
    }

    public boolean hasAssigned_to() {
	   return !getAssigned_to().isEmpty();
    }

    public void addAssigned_to(Student_Group newAssigned_to) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_ASSIGNED_TO,
                                       newAssigned_to);
    }

    public void removeAssigned_to(Student_Group oldAssigned_to) {
    ...
    public Collection<? extends Course> getAssists() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ASSISTS,
                                               DefaultCourse.class);
    }

    public boolean hasAssists() {
	   return !getAssists().isEmpty();
    }

    public void addAssists(Course newAssists) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_ASSISTS,
                                       newAssists);
    }

    public void removeAssists(Course oldAssists) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_ASSISTS,
                                          oldAssists);
    }
